...
-- **Lisa Sinclair** (Remote Sensing Scientist, Project Lead), **Jack Taylor** (Programmer-Analyst, Author - burn severity analysis), **Chris Girlamo** (Systems Administrator, Author - plume detection)
